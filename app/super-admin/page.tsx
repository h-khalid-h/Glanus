        ...
        <div className="space-y-8">
            ...
            <div className="flex items-start justify-between">
                ...
                <button
                    ...
                    onClick={fetchData}
                    disabled={loading}
                    className="flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2 text-xs text-slate-400 transition-colors hover:border-slate-700 hover:text-slate-300 disabled:opacity-50"
                >
            ...
            <section className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <h2 className="text-base font-semibold text-slate-100">Platform Alerts</h2>
                        <span className="text-xs text-slate-600">Last hour</span>
                    </div>
                    {loading ? (
                        <div className="space-y-3">
                            {[...Array(3)].map((_, i) => (
                                <div key={i} className="h-16 rounded-xl bg-slate-900/50 animate-pulse border border-slate-800/60" />
                            ))}
                        </div>
                    ) : (data?.alerts?.length ?? 0) === 0 ? (
                        <div className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-800/60 bg-slate-900/50 py-10 text-sm text-slate-500">
                    ...
                    <div className="rounded-2xl border border-slate-800/40 bg-slate-900/30 p-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">System Monitoring</p>
                        </div>
