    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link
                    href="/admin/asset-categories/new"
            ...
            {categories.length === 0 ? (
                <NoData resource="Categories" createHref="/admin/asset-categories/new" />
            ) : (
