...
export default function ActionsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            />
            <div className="mb-5">
                <Link href="/admin/asset-categories" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors mb-2">
                    <ArrowLeft size={14} />
                    Categories
                </Link>
                <div className="flex justify-between items-center">
                    ...
                    <Link
                        href={`/admin/asset-categories/${categoryId}/actions/new`}
                    ...
                    {actions.map((action) => (
                        <div key={action.id} className="detail-panel flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-1.5 pt-2 border-t border-border/60">
                                <Link
                                    href={`/admin/asset-categories/${categoryId}/actions/${action.id}/edit`}
